...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount AMX",
			labelI18n: "amount_amx",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumAMX",
			addonText: "AMX",
			addonI18n: "amx_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_amx', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceAMX';
		context['addonText'] = 'AMX';
		context['addonI18n'] = 'amx_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_amx', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
