...
var NRS = (function(NRS, $, undefined) {
    ...
    $("#dividend_payment_amount_per_share, #dividend_payment_height").on("blur", function() {
        ...
        var amountAMXPerShare = $modal.find("#dividend_payment_amount_per_share").val();
        ...
        if (amountAMXPerShare && /^\d+$/.test(height)) {
            NRS.getAssetAccounts(NRS.getCurrentAsset().asset, height,
                function (response) {
                    ...
                    var priceNQT = new BigInteger(NRS.calculatePricePerWholeQNT(NRS.convertToNQT(amountAMXPerShare), NRS.getCurrentAsset().decimals));
                    var totalAMX = NRS.calculateOrderTotal(totalQuantityQNT, priceNQT);
