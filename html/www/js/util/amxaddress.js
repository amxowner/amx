...
/*
    AMX address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: AmxChg (admin@amxchg.com).
*/
...
function AmxAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('AMX-') == 0) adr = adr.substr(4);
