...
var NRS = (function(NRS, $, undefined) {
	...
	NRS.initPluginWarning = function() {
		if (NRS.activePlugins) {
			...
			html += "Plugins are not sandboxed or restricted in any way and have full accesss to your client system including your Amx passphrase.";
			html += "</p>";
			...
			html += "you can loose your AMX! In doubt don't run plugins with accounts ";
			html += "used to store larger amounts of AMX now or in the future.";
			html += "</p>";
			html += "</div>";
