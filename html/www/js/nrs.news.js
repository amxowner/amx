	...
	NRS.pages.news = function() {
      ...
      var settingsReddit = {
         ...
         "filter": function(entry, tokens) {
            return tokens.title.indexOf("Donations toward") == -1 && tokens.title.indexOf("AMX tipping bot has arrived") == -1
         },
         "ssl": ssl
      };

      $("#amxforum_news").rss("http://forum.r6s6.com/index.php?action=.xml;type=rss", settings, NRS.newsLoaded);
      //$("#reddit_news").rss("http://www.reddit.com/r/AMX/.rss", settingsReddit, NRS.newsLoaded);
      //$("#amxcoin_blogspot_news").rss("http://amxcoin.blogspot.com/feeds/posts/default", settings, NRS.newsLoaded);
      //$("#amxer_news").rss("http://amxer.org/feed/", settings, NRS.newsLoaded);
		NRS.pageLoaded();
	};
