...
public class DesktopApplication extends Application {
		...
		public void start(Stage stage) throws Exception {
				...
				webEngine.setUserDataDirectory(Amx.getConfDir());
				...
				loadWorker.stateProperty().addListener(
								(ov, oldState, newState) -> {
										...
										stage.setTitle("AMX Desktop - " + webEngine.getLocation());
										if (newState == Worker.State.SUCCEEDED) {
												...
												Amx.getTransactionProcessor().addListener((transaction) ->
				...
				stage.getIcons().add(new Image(address + "/img/amx-icon-32x32.png"));
		...
		private static String getUrl() {
				...
				String defaultAccount = Amx.getStringProperty("amx.defaultDesktopAccount");
