...
import static amx.user.JSONResponses.DENY_ACCESS;
import static amx.user.JSONResponses.INCORRECT_REQUEST;
import static amx.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws AmxException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Amx.getBooleanProperty("amx.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|AmxException e) {
