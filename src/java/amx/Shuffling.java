...
import amx.crypto.AnonymouslyEncryptedData;
...
public final class Shuffling {
    ...
    private static final boolean deleteFinished = Amx.getBooleanProperty("amx.deleteFinishedShufflings");
    ...
    private void cancel(Block block) {
        ...
        if (blamedAccountId != 0) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Logger.logDebugMessage("Shuffling penalty %f " + Constants.COIN_NAME + " awarded to forger at height %d", ((double)fee) / Constants.ONE_AMX, block.getHeight() - i - 1);
            }
            ...
            Logger.logDebugMessage("Shuffling penalty %f " + Constants.COIN_NAME + " awarded to forger at height %d", ((double)fee) / Constants.ONE_AMX, block.getHeight());
        }
