...
import static amx.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static amx.http.JSONResponses.UNKNOWN_ACCOUNT;
import static amx.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer AMX, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * AMX amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  AmxException        Unable to process request
     */
    @Override
