...
/**
 * Issue a currency on the AMX blockchain
 * <p>
 * A currency is the basic block of the AMX Monetary System it can be exchanged with AMX, transferred between accounts,
 ...
 * For {@link amx.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum AMX value per unit to allow the currency to become active
 * For {@link amx.CurrencyType#RESERVABLE} currency
 ...
 * For {@link amx.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link amx.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link amx.crypto.HashFunction algorithm} used for minting.
 * For {@link amx.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link amx.CurrencyType#EXCHANGEABLE} nor {@link amx.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link amx.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link amx.CurrencyType#RESERVABLE} becomes active, in case it is {@link amx.CurrencyType#CLAIMABLE} the AMX used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link amx.CurrencyType#RESERVABLE} becomes active, in case it is non {@link amx.CurrencyType#CLAIMABLE} the AMX used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link amx.CurrencyType#MINTABLE} currency, the number of units per {@link amx.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link amx.http.CurrencyMint}<br>
 * </ul>
 *
 * @see amx.CurrencyType
 * @see amx.crypto.HashFunction
 */
