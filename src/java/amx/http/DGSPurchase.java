...
import static amx.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static amx.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static amx.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static amx.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
import static amx.http.JSONResponses.UNKNOWN_GOODS;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws AmxException {
        ...
        try {
            ...
            if (deliveryDeadline <= Amx.getEpochTime()) {
