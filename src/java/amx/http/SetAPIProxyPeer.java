...
import static amx.http.JSONResponses.API_PROXY_NO_OPEN_API_PEERS;
import static amx.http.JSONResponses.PEER_NOT_CONNECTED;
import static amx.http.JSONResponses.PEER_NOT_OPEN_API;
import static amx.http.JSONResponses.UNKNOWN_PEER;
...
public class SetAPIProxyPeer extends APIServlet.APIRequestHandler {
    ...
    @Override
    protected JSONStreamAware processRequest(HttpServletRequest request) throws AmxException {
