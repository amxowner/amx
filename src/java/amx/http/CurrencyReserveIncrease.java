...
/**
 * Increase the value of currency units by paying AMX
 * <p>
 * Parameters
 * <ul>
 ...
 * Constraints
 * <p>
 * This API is allowed only when the currency is {@link amx.CurrencyType#RESERVABLE} and is not yet active.
 * <p>
 ...
 * The list of founders and their NQT investment can be obtained using the {@link amx.http.GetCurrencyFounders} API.
 */
