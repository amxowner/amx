...
public abstract class AmxException extends Exception {

    protected AmxException() {
        super();
    }

    protected AmxException(String message) {
        super(message);
    }

    protected AmxException(String message, Throwable cause) {
        super(message, cause);
    }

    protected AmxException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends AmxException {
    ...
    public static final class AmxIOException extends IOException {

        public AmxIOException(String message) {
            super(message);
        }

        public AmxIOException(String message, Throwable cause) {
            super(message, cause);
        }
