...
//        return "AMX-" + Crypto.rsEncode(accountId);
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws AmxException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new AmxException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseAMX(String amx) {
        return parseStringFraction(amx, 8, Constants.MAX_BALANCE_AMX);
    }
