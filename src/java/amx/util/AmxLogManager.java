...
/**
 * Java LogManager extension for use with Amx
 */
public class AmxLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the Amx log manager
     *
     ...
     * done terminating the Amx processes.
     */
    public AmxLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during Amx shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Amx shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void amxShutdown() {
        super.reset();
