...
import amx.AmxException.AmxIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  AmxIOException      Maximum count exceeded
     */
    private void incCount(long c) throws AmxIOException {
        count += c;
        if (count > limit)
            throw new AmxIOException("Maximum size exceeded: " + count);
    }
}
