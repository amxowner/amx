...
public final class Constants {
    ...
    public static final String COIN_NAME = "AMX";
    public static final boolean isTestnet = Amx.getBooleanProperty("amx.isTestnet");
    public static final boolean isOffline = Amx.getBooleanProperty("amx.isOffline");
    public static final boolean isLightClient = Amx.getBooleanProperty("amx.isLightClient");

    public static final int MAX_NUMBER_OF_TRANSACTIONS = 255;
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_AMX = 10000000000L;
    public static final long ONE_AMX = 100000000;
    //public static final long TRANSACTION_FEE = ONE_AMX / Amx.getIntProperty("amx.reductorFee", 1); //suse
    public static final long REDUCTOR_FEE = Amx.getIntProperty("amx.reductorFee", 1); //suse
    public static final long MAX_BALANCE_NQT =  MAX_BALANCE_AMX * ONE_AMX;
    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long MAX_BASE_TARGET =  MAX_BALANCE_AMX * INITIAL_BASE_TARGET;
    ...
    public static final int MAX_ROLLBACK = Math.max(Amx.getIntProperty("amx.maxRollback"), 720);
    //public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Amx.getIntProperty("amx.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Amx.getIntProperty("amx.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? Amx.getIntProperty("amx.testnetLeasingDelay", 1440) : 1440;
    //suse public static final int MAX_LEASING_PERIOD = 65535;
    public static final int MAX_LEASING_PERIOD = 65535;
    public static final long MIN_FORGING_BALANCE_NQT = 200000 * ONE_AMX;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = Amx.getIntProperty("amx.forgingDelay");
    public static final int FORGING_SPEEDUP = Amx.getIntProperty("amx.forgingSpeedup");
		public static final int BATCH_COMMIT_SIZE = Amx.getIntProperty("wcg.batchCommitSize", Integer.MAX_VALUE);
    ...
    static {
        int maxPrunableLifetime = Amx.getIntProperty("amx.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = Amx.getBooleanProperty("amx.includeExpiredPrunable");
    ...
    public static final int MAX_MINTING_RATIO = 150000000; // Targeting remaining 33% of currency mined in 10 years, at max block rate
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_AMX;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_AMX;

    public static final boolean correctInvalidFees = Amx.getBooleanProperty("amx.correctInvalidFees");
    ...
    public static final String SECRETPHRASE_PREFIX = "amx";

    public static final long COINBASE_PERIOD = 3000000L;
    public static final long COINBASE_MAX = 3400000000L;
    public static final float COINBASE_INITIAL = 450.0f;
    public static final float COINBASE_FACTOR = 0.67f;
    
    public static final long ISSUE_ASSET_FEE = 5000;
