...
import amx.Amx;
import amx.http.APIServlet;
import amx.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        Amx.getStringListProperty("amx.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Amx.getBooleanProperty("amx.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Amx.isDesktopApplicationEnabled() ? "amxdesktop.policy" : "amx.policy");
