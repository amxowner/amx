...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws AmxException.NotValidException;

        Transaction build(String secretPhrase) throws AmxException.NotValidException;
    ...
    void validate() throws AmxException.ValidationException;
