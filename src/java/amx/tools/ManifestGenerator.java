...
import amx.Amx;
import amx.env.service.AmxService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/amx.manifest.mf", Amx.class.getCanonicalName(), "./lib");
        String serviceClassName = AmxService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/amxservice.manifest.mf", serviceClassName, "./lib");
    }
